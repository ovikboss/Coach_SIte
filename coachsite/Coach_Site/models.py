...
class Chat(models.Model):
    user = models.ForeignKey(
        settings.AUTH_USER_MODEL, related_name="chats_as_user", on_delete=models.CASCADE
    )
    coach = models.ForeignKey(
        "Coach_Site.Coach", related_name="chats_as_coach", on_delete=models.CASCADE
    )
    created_at = models.DateTimeField(auto_now_add=True)
...
class AvailableSlot(models.Model):
    coach = models.ForeignKey(
        "Coach_Site.Coach", on_delete=models.CASCADE, related_name="available_slots"
    )
...
class TrainingSession(models.Model):
    ...
    coach = models.ForeignKey(
        "Coach_Site.Coach", on_delete=models.CASCADE, related_name="training_sessions"
    )
    ...
    def __str__(self):
        return f"Тренировка {self.user.username} с {self.coach.user.username} "
